...
public final class CommonToolProperties {
  ...
  public static void accumulateProperties(Context context,
    ...
    if (deviceProperties != null) {
      ...
      deviceProperties.remove(KEY_IS_USER_AUTHENTICATED);
      deviceProperties.put(KEY_CURRENT_USER_STATE, "LOGGED_OUT");
      deviceProperties.remove(KEY_LAST_SYNC_INFO);
      ...
      deviceProperties.remove(KEY_IS_ANONYMOUS_ALLOWED);
      deviceProperties.remove(KEY_COMMON_INITIALIZATION);
