...
public final class PRNGFixes {
  ...
  private static void installLinuxPRNGSecureRandom() throws SecurityException {
    ...
    if (!LinuxPRNGSecureRandomProvider.class.equals(rng2.getProvider().getClass())) {
      throw new SecurityException(
          "SecureRandom.getInstance(\"SHA1PRNG\") backed by wrong" + " Provider: " + rng2
  ...
  private static class LinuxPRNGSecureRandom extends SecureRandomSpi {
         ...
         * serialized (on urandomMutex) to ensure that multiple threads do not get
         * duplicated PRNG output.
         */

    private static final File URANDOM_FILE = new File("/dev/urandom");

    private static final Object urandomMutex = new Object();
