...
public class PropertiesFileUtilsTest {
    ...
    public void testWritePropertiesIntoCsv_NullAppName() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(null, tableId, orderedDefns, kvsEntries, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_NullTableId() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, null, orderedDefns, kvsEntries, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_NullOrderedDefns() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, null, kvsEntries, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_NullKvsEntries() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, orderedDefns, null, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    @Test
    public void testReadPropertiesFromCsv_NullAppName() {
        // Test reading properties from CSV with null appName
        try {
            PropertiesFileUtils.readPropertiesFromCsv(null, tableId);
    ...
    public void testWritePropertiesIntoCsv_IOException() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, orderedDefns, kvsEntries, new File("definition.csv"), new File("properties.csv"));
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_PermissionDenied() throws IOException, ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, orderedDefns, kvsEntries, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_NullPropertiesCsv() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, orderedDefns, kvsEntries, definitionCsv, null);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_NullAppNameAndTableId() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(null, null, orderedDefns, kvsEntries, definitionCsv, propertiesCsv);
        assertFalse(success);
    }
    ...
    public void testWritePropertiesIntoCsv_DifferentDefinitionAndPropertiesCsv() throws ServicesAvailabilityException {
        ...
        boolean success = PropertiesFileUtils.writePropertiesIntoCsv(appName, tableId, orderedDefns, kvsEntries, differentDefinitionCsv, propertiesCsv);
        assertFalse(success);
    }
